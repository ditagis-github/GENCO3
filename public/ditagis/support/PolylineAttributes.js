        ...
        return class {
            ...
            isThietBiTruyenDan(geometry) {
                return new Promise((resolve, reject) => {
                    const tbtdLayer = this.view.map.findLayerById(constName.THIETBITRUYENDAN);
            ...
            */
            async getAttributes(geometry) {
                ...
                if (this.layer.id === constName.HETHONGTRUYENDANVIENTHONG) {
                    ...
                    for (var index = 0, count = 1; index < pathsToPoints.length; index++ , count++) {
                        ...
                        const xaHuyen = await this.editingSupport.getLocationInfo({geometry:point});
